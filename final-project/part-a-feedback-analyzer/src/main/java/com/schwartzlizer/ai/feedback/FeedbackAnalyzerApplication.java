...
public final class FeedbackAnalyzerApplication {
    ...
    public static void main(String[] args) { int code = run(args, System.out, System.err); if (code != 0) System.exit(code); }
    static int run(String[] args, PrintStream out, PrintStream err) {
        if (args == null || args.length != 1) { err.println("Usage: feedback-analyzer <csv-path>"); return 2; }
        try {
            ...
            return 0;
        } catch (Exception e) { err.println(e.getMessage()); return 1; }
    }
}
